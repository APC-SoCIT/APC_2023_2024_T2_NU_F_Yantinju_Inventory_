    ...
    <div class="chatbot">
      ...
      <ul class="chatbox">
        <li class="chat incoming">
          ...
          <p>Hi there, <?php echo $_SESSION['fname']; ?>👋<br>How can I help you today?</p>
        </li>
      </ul>
      <div class="chat-input">
        <textarea type="text" id="data" placeholder="Enter a message..." spellcheck="false" required></textarea>
