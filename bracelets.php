<div class="col-md-9">
        ...
        <div class="panel-body">
            <div class="pull-right">
                ...
                <?php
                    ...
                    $count_query = "SELECT COUNT(*) AS total FROM paninda WHERE category='Bracelets' AND status='Available'";
    ...
    <div class="row product-list">
        ...
        <?php 
            ...
            $get_pro = "SELECT * FROM paninda WHERE category='Bracelets' AND status='Available' LIMIT $offset, $per_page";
                ...
                <div class="col-md-4">
                        <section class="panel">
                            ...
                            <form action="" method="post">
                                <a href="products.php?item&products=<?php echo $productName ?>">
                                <img src="admin_area/images/products/<?php echo $productImage ?>" alt="" />
                                </a>
                                <a href="adtocart.php?products=<?php echo $productName ?>" class="adtocart">
                                <i class="fa-solid fa-circle-plus" id="icon"></i>
                                </a>
                            ...
                            <div class="panel-body text-center">
                                <h4>
                                    <a href="products.php?item&products=<?php echo $productName ?>" name="productName" class="pro-title"><?php echo $productName ?></a>
                                </h4>
