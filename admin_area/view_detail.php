                ...
                <div class="mt-10 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
                    ...
                    <div class="flex flex-col justify-start items-start dark:bg-gray-800 bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
                        ...
                        foreach ($products as $product) {
                            // Extract item_name and quantity directly in the if condition
                            if (preg_match('/^(.*?) \((\d+)\)$/', trim($product, " \t\n\r\0\x0B("), $matches)) {
                                $item_name = trim($matches[1]); // Get the item name
                                $quantity = (int)$matches[2];   // Get the quantity
        ...
        <div class="mt-4 md:mt-6 flex flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full">
            ...
            <div class="border-b border-gray-300 md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
                <div class="w-full flex flex-col justify-start items-start space-y-8">
                    <h3 class="text-base dark:text-white xl:text-lg font-semibold leading-6 text-gray-800"><?php echo $item_name ?></h3>
                </div>
