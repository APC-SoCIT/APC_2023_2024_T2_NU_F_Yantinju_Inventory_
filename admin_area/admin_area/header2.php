...
<div class="sidebar">
    <div class="sidebar-container">
        ...
        <div class="sidebar-menu">
            <ul>
                <li><a href="adminpanel.php?dashboard" class="<?php if(isset($_GET['dashboard']) || isset($_GET['view_complete_detail'])){ echo "active"; } ?>"><span class="las la-users"></span><span>Dashboard</span></a></li>
