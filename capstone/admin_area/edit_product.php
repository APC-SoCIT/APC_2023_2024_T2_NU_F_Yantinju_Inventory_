...
?>
        ...
        <main>
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal Starts -->
                ...
                <input type="number" name="product_quantity2" class="form-control" required value="<?php echo $stock2; ?>" <?php echo getQuantityStyle($stock2); ?>>
                ...
                <input type="number" name="product_quantity3" class="form-control" required value="<?php echo $stock3; ?>" <?php echo getQuantityStyle($stock3); ?>>
                ...
                <input type="number" name="product_quantity4" class="form-control" required value="<?php echo $stock4; ?>" <?php echo getQuantityStyle($stock4); ?>>
                ...
                <input type="number" name="product_quantity5" class="form-control" required value="<?php echo $stock5; ?>" <?php echo getQuantityStyle($stock5); ?>>
                ...
                <input type="number" name="product_quantity6" class="form-control" required value="<?php echo $stock6; ?>" <?php echo getQuantityStyle($stock6); ?>>
                ...
                <input type="number" name="product_quantity" class="form-control" required value="<?php echo $quantity; ?>" <?php echo getQuantityStyle($quantity); ?>>
        ...
        <?php
        // Function to generate inline style based on quantity value
        function getQuantityStyle($quantity) {
            // Initialize empty style attribute
            $style = '';

            // Check if quantity is 0 or below 20
            if ($quantity === '0') {
                $style = 'style="border-color: red; background-color: #F8D7DA;"';
            } elseif ($quantity < 20 && $quantity > 0) {
                $style = 'style="border-color: orange; background-color: #FFEBC7;"';
            }
