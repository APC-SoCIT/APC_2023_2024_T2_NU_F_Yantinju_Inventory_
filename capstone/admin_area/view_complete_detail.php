            ...
            <div class="header-title ">
                ...
                <p>
                    <ul class="breadcrumb" style="background-color:#f5eedc; padding: 0 0; font-size: 0.9rem;">
                        <li><a href="adminpanel.php?dashboard">Dashboard</a></li>
        ...
        <main>
            ...
            $get_pro2 = "SELECT * FROM `complete_order` WHERE order_id='$view_id'";
...
?>
                    ...
                    <div class="flex justify-center flex-col md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                        ...
                        <div class="flex justify-between items-start w-full">
                            ...
                            <select name="stats" class="form-control" disabled>
                        ...
                        <div class="w-full flex justify-center items-center">
                            <button id="changeButton" class="hover:bg-black dark:bg-white dark:text-gray-800 dark:hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 py-5 w-96 md:w-full bg-gray-800 text-base font-medium leading-4 text-white" name="change" disabled>Change</button>
                        </div>
                        </form>
                        </div>
                    </div>
