<div class="panel panel-default sidebar-menu"><!-- panel panel-default sidebar-menu Starts -->
    ...
    <div class="panel-body"><!-- panel-body Starts -->
        <ul class="nav nav-pills nav-stacked"><!-- nav nav-pills nav-stacked Starts -->
            <li class="<?php if (isset($_GET['my_orders']) || isset($_GET['send_payment'])) {
                echo "active";
            } ?>">
                <a href="account.php?my_orders&confirm=logged_in"> <i class="fa fa-list"></i> My Orders </a>
            </li>
            <li class="<?php if (isset($_GET['edit_profile'])) {
                echo "active";
            } ?>">
                <a href="account.php?edit_profile&confirm=logged_in"> <i class="fa-solid fa-id-badge"></i> Edit Profile </a>
            </li>
            <li class="<?php if (isset($_GET['edit_address'])) {
                echo "active";
            } ?>">
                <a href="account.php?edit_address&confirm=logged_in"> <i class="fa fa-pencil"></i> Edit Address </a>
            </li>
            <li>
