...
<tr <?php echo ($mop == 'GCash' && empty($moppic)) ? 'style="background-color: #FFCCCB;"' : ''; ?>>
    <th><?php echo $i; ?></th>
    ...
    <td>
        ...
        <?php if ($mop == 'GCash'){ ?>
            <a href="account.php?send_payment&pay_order=<?php echo $order_id;?>&confirm=logged_in" class="btn btn-primary btn-xs <?= (empty($moppic))?'':'disabled'; ?>"> Send Payment </a> 
        <?php } ?>
    </td>
</tr><!-- tr Ends -->
