<div class="col-md-9">
        ...
        <div class="panel-body">
            <div class="pull-right">
                ...
                <?php
                    ...
                    $count_query = "SELECT COUNT(*) AS total FROM paninda WHERE category='Pendants' AND status='Available'";
    ...
    <div class="row product-list">
        ...
        <?php 
            ...
            $get_pro = "SELECT * FROM paninda WHERE category='Pendants' AND status='Available' LIMIT $offset, $per_page";
