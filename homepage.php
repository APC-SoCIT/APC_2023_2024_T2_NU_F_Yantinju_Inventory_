            ...
            ?>
                <div class="best-p1">
                    ...
                    <div class="best-p1-txt">
                        ...
                        <div class="add-cart">
                            <button><a href="products.php?item&products=<?php echo $pro_title; ?>">buy now</a></button>
                        </div>
                    </div>
                </div>
            <?php
            ...
            ?>
                <div class="best-p1">
                    ...
                    <div class="best-p1-txt">
                        ...
                        <div class="add-cart">
                            <button><a href="products.php?item&products=<?php echo $pro_title; ?>">more details</a></button>
                        </div>
                    </div>
                </div>
                <?php
            ...
            ?>
                <div class="best-p1">
                    ...
                    <div class="best-p1-txt">
                        ...
                        <div class="buy-now">
                            <button><a href="products.php?item&products=<?php echo $pro_title; ?>">add to cart</a></button>
                        </div>
                    </div>
                </div>
            <?php
